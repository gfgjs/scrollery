// src/i18n/core.spec.ts
// i18n 完整性契约。2026-09-16 由 localeIntegrity.spec.ts(键树对齐 + 全库字面量键存在性)与
// backupMessages.spec.ts(备份文案两语言键一致)集中而来,原两文件删去;每条场景仍是独立 it。
//
// R1-7 i18n 完整性锁(防回潮,上 CI):
